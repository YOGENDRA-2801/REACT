...
function App() {
  ...
  return (
    ...
    <div>
      ...
      {/* <Alert alrtMsg="This is custom alert message"></Alert> -- BASIC */}
      {/* <Alert alrtMsg={alert}/> -- WITH DYNAMIC VALUE */}

      {/* <div className="container my-3"> -- CENTRE ME LANE K LIYE */}
      {/* container -- predefined class in bootstrap , 
          my-3 : y-axis m 3 ka margin set krta hai [example 2 line k bich m margin] */}
