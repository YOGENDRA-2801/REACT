  ...
  return (
    <>
      <div style={{ height: "50px" }}>
        {props.alrtMsg && (
          <div
            className={`alert alert-${props.alrtMsg.type} alert-dismissible fade show`}
            role="alert"
          >
            <strong>{props.alrtMsg.type} : </strong>
            {props.alrtMsg.message}
            {/* 
...
// Solution -- Enn component ko inki khud ki height width dedo hence jab absent rhnge tabhi bhi inka space reserve hoga
